...
cc_library(
    ...
    srcs = [
        ...
        "src/google/protobuf/io/coded_stream_ext.cc",
        "src/google/protobuf/io/zero_copy_stream_ext.cc",
        "src/google/protobuf/rawstring.cc",
...
cc_library(
    ...
    srcs = [
        ...
        "src/google/protobuf/compiler/cpp/cpp_rawstring_field.cc",
